...
//"file location" + number variable + ".imageformat" 
 ...
 function changeBackground(){ 
    ...
    if (months == 0){background.image = "jan/" + days + ".jpeg";}
    
    else if (months == 1){background.image = "feb/" + days + ".jpeg";}
    
    else if (months == 2){background.image = "mar/" + days + ".jpeg";}
       
    else if (months == 3){background.image = "apr/" + days + ".jpeg";}
       
    else if (months == 4){background.image = "may/" + days + ".jpeg";}
       
    else if (months == 5){background.image = "jun/" + days + ".jpeg";}
       
    else if (months == 6){background.image = "jul/" + days + ".jpeg";}
           
   else if (months == 7){background.image = "aug/" + days + ".jpeg";}
              
   else if (months == 8){background.image = "sep/" + days + ".jpeg";}
       
   else if (months == 9){background.image = "oct/" + days + ".jpeg";}
         
   else if (months == 10){background.image = "nov/" + days + ".jpeg";}
       
   else if (months == 11){background.image = "dec/" + days + ".jpeg";}
